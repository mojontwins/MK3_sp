...
// System stuff
	...
	#define SW_SPRITES_8x8					3		// # of 8x8 software sprites

	#define SW_SPRITES_ALL					(SW_SPRITES_16x24+SW_SPRITES_16x16+SW_SPRITES_16x8+SW_SPRITES_8x16+SW_SPRITES_8x8)

	#define SPR_PLAYER						0
	#define SPR_CHARACTER 					1		// Only on CPC
	#define SPR_ENEMS_BASE					2
...
// Map format
	...
	#else
		#define PRY_MAX 		160		
		#define PRY_MAX_COCO	152
		#define MAP_CHARSH 		20
		#define TY_MAX			10
	#endif
...
// Enems stuff
	...
	#endif
	#ifdef CPC 
		#define ENEMS_CELL_BASE					20	// 13 player, 6 characters, 1 empty
	#endif
...
// Define those to include all related code
	...
	#define HOTSPOTS_BASE_TILE				16		// Draw tile hrt+constant
...
// Animation cells
	...
	#ifdef CPC
		const unsigned char walk_frames [] = {0, 1, 0, 2};
		#define CELL_FACING_RIGHT 				0
		#define CELL_FACING_LEFT 				3
		#define CELL_FACING_DOWN				6
		#define CELL_FACING_UP 					9
		#define CELL_IDLE 						0
		#define CELL_HURT 						12
	#endif
